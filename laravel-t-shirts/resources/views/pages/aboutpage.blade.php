...
@section('content')
    <div class="container py-3 bg-white">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div>
                    <img src="../img/gallery-1.jpg" alt="Gallery image 1" class="w-100 mb-2 mb-md-4 rounded gallery-imgs" onclick="zoomGallery(this)">
                </div>
                <div>
                    <img src="../img/gallery-2.jpg" alt="Gallery image 1.2" class="w-100 mb-2 mb-md-4 rounded gallery-imgs" onclick="zoomGallery(this)">
                </div>
            </div>
            <div class="col-lg-4">
                <div>
                    <img src="../img/gallery-3.jpg" alt="Gallery image 1" class="w-100 mb-2 mb-md-4 rounded gallery-imgs" onclick="zoomGallery(this)">
                </div>
                <div>
                    <img src="../img/gallery-4.jpg" alt="Gallery image 1.2" class="w-100 mb-2 mb-md-4 rounded gallery-imgs" onclick="zoomGallery(this)">
                </div>
            </div>
            <div class="col-lg-4">
                <div>
                    <img src="../img/gallery-5.jpg" alt="Gallery image 1" class="w-100 mb-2 mb-md-4 rounded gallery-imgs" onclick="zoomGallery(this)">
                </div>
                <div>
                    <img src="../img/gallery-6.jpg" alt="Gallery image 1.2" class="w-100 mb-2 mb-md-4 rounded gallery-imgs" onclick="zoomGallery(this)">
                </div>
            </div>
        </div>
        <!--Zoom & Close-->
        ...
        <div class="row">
            <div class="col-lg-4 text-center py-2">
                <img src="../img/team-1.jpg" alt="Team 1" class="rounded-circle" width="200" height="200">
                <p></p>
                ...
                <a href="https://www.linkedin.com/" target="blanck" class="text-decor">
                    <i class="fab fa-linkedin-in h3 px-2"></i>
                </a>
            </div>
            <div class="col-lg-4 text-center py-2">
                <img src="../img/team-2.jpg" alt="Team 2" class="rounded-circle" width="200" height="200">
                <p></p>
                <h4>Maria Rusu</h4>
                <h5>manager</h5>
            ...
            <div class="col-lg-4 text-center py-2">
                <img src="../img/team-3.jpg" alt="Team 3" class="rounded-circle" width="200" height="200">
                <p></p>
                <h4>Alina Ceobanu</h4>
                <h5>designer</h5>
